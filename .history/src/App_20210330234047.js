  ...
  return (
    <div className=" container mt-5 ">
      <div className="row border">
        <div className="col-12 col-md-6 border shadow-lg p-3 mb-5 bg-body rounded fondo">
          <Header
        ...
        <div className="col-12 col-md-6  border shadow-lg p-3 mb-5 bg-body rounded" >
          <Header
        ...
        <div className="col-12 col-sm-12 border shadow-lg p-3 mb-5 bg-body rounded">
          <Header
