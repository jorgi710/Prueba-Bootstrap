  ...
  return (
    <div className=" container mt-5 ">
      <div className="row border">
        <div className="col-4 border shadow-lg p-3 mb-5 bg-body rounded fondo">
          <Header
        ...
        <div className="col-4 border shadow-lg p-3 mb-5 bg-body rounded" style={{background:"#E3E4E9"}}>
          <Header
