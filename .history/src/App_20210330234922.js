  ...
  return (
    <div className=" container mt-5 ">
      <div className="row border">
        <div className="col-12 col-md-6 col-xl-4 border shadow-lg p-3 mb-5 bg-body rounded fondo">
          <Header
        ...
        <div className="col-12 col-md-6 col-xl-4 border shadow-lg p-3 mb-5 bg-body rounded" >
          <Header
          ...
          <Description
            ...
            description_price="*Receive credit on tution already paid on "
            description_price_messages="Virtual Training!"
          />
          <Footer
            text_footer="COMPANY SIGN UP FOR:"
        ...
        <div className="col-12 col-xl-4 border shadow-lg p-3 mb-5 bg-body rounded">
          <Header
