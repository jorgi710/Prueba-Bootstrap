...
const Content = ({
  ...
  return (
    <div>
      <h5 className="text-center my-3 text-primary" style={{fontSize:"medium", color:"#3D499A"}}>{title_name}</h5>
      <ul className=" align-content-left my-1">
        ...
        <li className="my-1" style={{fontSize:"medium", color:"#3D499A"}}>{list_4}</li>
