...
const Logo = () => {
  return (
    <>
      ...
      >
        <div className="p-6 bg-white p-4 text-success">
          <h4>
            <h6 style={{fontSize:"medium"}}>FULL ACCESS <br/> MEMBERSHIP</h6>
        ...
        <div
          className="p-6 bg-primary p-4 "
          style={{ borderRadius: " 0 15px 15px  " }}
        >
          <h1>2<b className="text-primary">_</b>YEARS $5,799</h1>
        </div>
      </div>
      <div>
