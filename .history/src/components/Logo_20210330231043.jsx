      ...
      >
        <div className="p-6 bg-white p-4 ">
          <h4 className="text-secondary">
            ...
            <h3
              className="bg-secondary text-primary pr-3 pl-2"
              style={{ opacity: "0.6" }}
            >
              for
            </h3>
        ...
        <div
          className="p-2  p-4 "
          style={{ borderRadius: " 0 8px 8px 0 ", fontWeight: "bold", color:"#343893" }}
        >
          <h1 className="text-white">
            2<b className="text-primary">_</b>YEARS {price_logo_principal}*
          </h1>
        </div>
      </div>
    </>
